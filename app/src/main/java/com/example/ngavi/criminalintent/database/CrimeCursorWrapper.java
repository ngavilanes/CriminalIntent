...
import com.example.ngavi.criminalintent.Crime;
...
public class CrimeCursorWrapper extends CursorWrapper {
    ...
    public Crime getCrime(){  //cursor used to get contentvalues from database and return these values as a new crime
